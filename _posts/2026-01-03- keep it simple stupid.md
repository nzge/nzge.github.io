...
capstone project. my concept involved multiple servos, mechanical, hardware and software complexity. in the end my team, perhaps smarter than me, came up with a four bar linkage that worked
almost flawlessly for our given task (a delivery robot) 

considering how advanced ai has become, it seemingly can't grasp this this crucial engineering concept (especially considering ironically, the tools that birthed ai presumably was created by
competent engineers, hence you would think they tried to program in this thinking into it. perhaps that is not so straightforward of an implementation though).